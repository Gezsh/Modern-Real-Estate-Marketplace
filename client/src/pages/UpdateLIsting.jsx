...
function UpdateLIsting() {
  ...
  useEffect(()=>{
    ...
    await axios.get(`/api/listing/getListing/${listingId}`)
            .then(response=>{
     ...
     e.preventDefault();
      try{
        ...
        if(+formData.regularPrice < +formData.discountPrice) return setError("discount price must be lower than regular price")
          setLoading(true)
          setError(false)
          axios.patch(`/api/listing/update/${params.listingId}`,{...formData, UserRef : currentUser._id})
                .then(response=>{
    ...
    <MainContainer>
       ...
       <Form onSubmit={handleSubmit}>
          ...
          <RightColumn>
               ...
               <CreateListingBut disabled={loading || uploading} >{loading ? 'Loading...' : 'Update listing'}</CreateListingBut>
